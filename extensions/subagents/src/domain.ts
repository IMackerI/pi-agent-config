...
/** Internal union stays broad so the backend-neutral manager remains reusable and testable. */
...
/**
 * Pi's thinking-level scale. Omitted means the child inherits the parent level.
 */
...
export interface SpawnTask {
  ...
  readonly cwd: string;
  /**
   * Pi model hint: "provider/model-id" or bare model id. Omitted = inherit.
   */
...
export interface SubagentMeta {
  ...
  /** Native child session id, when available. */
